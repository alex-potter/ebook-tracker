...
export default function BottomNav({ activeTab, onChange }: BottomNavProps) {
  return (
    <nav className="flex-shrink-0 z-40 bg-paper-raised border-t border-border flex items-center justify-around lg:fixed lg:left-0 lg:top-0 lg:h-full lg:w-16 lg:flex-col lg:justify-start lg:pt-4 lg:gap-2 lg:border-t-0 lg:border-r" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
