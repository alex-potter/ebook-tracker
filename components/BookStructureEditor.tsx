                    ...
                    {editingTitle === book.index ? (
                      ...
                      <div className="flex items-center gap-1.5 min-w-0">
                        ...
                        {!isLocked && (
                          <button
                            type="button"
                            onClick={(e) => { e.stopPropagation(); setEditingTitle(book.index); }}
                            className="flex-shrink-0 p-1 -m-1 text-stone-400 dark:text-zinc-500 hover:text-amber-500 dark:hover:text-amber-400 transition-colors"
                            title="Rename book"
